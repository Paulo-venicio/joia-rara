    ...
    ?> <!--  fim do bloco PHP -->
        ...
        <tr><!-- linha da tabela(HTML) para organizar os Campos da Tabela(MySql) do Banco de Dados -->
            ...
            <td><!-- Coluna para inserção do botão de Alterar Registro -->
                <button class="btn_amarelo"><a id="btnf_alt_usu" href="alterar_pes.php?ID=<?php echo $row["ID"]?>">Alterar</a></button><?php $id = $row["ID"]?>
            </td> <!-- Final da Coluna do Compo [Botão Deletar] -->
            
            <td><!-- Coluna para inserção do botão de Apagar Registro -->
                <button class="btn_vermelho"><a id="btnf_del_usu" href="apagar_pes.php?ID=<?php echo $row["ID"]?>">Deletar</a></button><?php $id = $row["ID"]?>
            </td> <!-- Final da Coluna do Compo [Botão Deletar] -->
